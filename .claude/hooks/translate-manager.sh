...
# @context Provides manual override for target translation language
...
# @why Implements priority: manual override > no translation
...
set_translate() {
    ...
    if [[ "$lang" == "auto" ]]; then
        ...
        echo "  No translation source configured, will speak English"
        return
    fi
