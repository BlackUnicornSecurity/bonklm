...
const DANGEROUS_ENV_VARS: Array<[string, string]> = [
...
function checkDangerousEnvVars(): Array<[string, string]> {
...
function initializeLogs(): boolean {
    try {
...
function logSessionStart(status: string, issues: string[]): void {
