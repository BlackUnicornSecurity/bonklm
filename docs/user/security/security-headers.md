...
> **Last updated:** 2026-08-14 · **Package version:** `1.0.15`

The BonkLM Fastify plugin does not set HTTP response headers — header policy belongs to the hosting
application. This guide shows recommended framework configuration in front of the guardrails
