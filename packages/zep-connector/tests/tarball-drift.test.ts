/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-zep` (ST-04-336).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/zep-connector
...
describe('tarball drift — @blackunicorn/bonklm-zep', () => {
