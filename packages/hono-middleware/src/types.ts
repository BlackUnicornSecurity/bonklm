 ...
 *
 * Pre-1.0 pin: peer `hono ^4.12.0` is intentionally tight. Hono 4.x is
 * post-1.0 and stable across minors, but the v5 ABI may break — we
 * re-align this file when bumping the peer range.
 */
