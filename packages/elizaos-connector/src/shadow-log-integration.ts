/**
 * Shadow log integration into the ElizaOS connector
 * ===============================================================
 *
...
export async function verifyAndReadAuthenticatedMessages(
  ...
  // Cross-room authorization — connector layer responsibility.
  // Throws when the room is not in the session's set.
...
/**
 * backwards-compat: emit a WARNING when
