 ...
 *
 * Phase-1 ships the exact-match check only; the Levenshtein
...
export interface BonklmPluginOptions {
   ...
   * to `process.env`. Locked 6-key contract plan.
   */
  ...
  /**
   * Phase-2: shadow log for Class-4 structural defence.
   *
  ...
  /**
   * Phase-2: callback returning the authenticated room IDs
...
export interface IAgentRuntimeLike {
  ...
  /**
   * Phase-2: optional event-subscription API. ElizaOS v1
