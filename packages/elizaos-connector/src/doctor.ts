/**
 * Construct D — `bonklm doctor` CLI core
 * ================================================
 *
...
/**
 * Phase-2: regex matching installed
 ...
 *
 * Phase-2 (connectors): exact-match check is augmented
...
/**
 * Phase-2 EOL finding helper. Audits the consumer-supplied
 ...
 *
 * Phase-2: accepts an optional `installedVersions` record
