/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-elizaos` (ST-04-306).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/elizaos-connector
...
describe('tarball drift — @blackunicorn/bonklm-elizaos', () => {
