/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-mem0` (ST-04-335).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/mem0-connector
...
describe('tarball drift — @blackunicorn/bonklm-mem0', () => {
