/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-document-ingest` (ST-04-341).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/document-ingest
...
describe('tarball drift — @blackunicorn/bonklm-document-ingest', () => {
