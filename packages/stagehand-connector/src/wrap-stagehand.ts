...
export function wrapStagehand<T extends StagehandLike>(
  ...
  (client as { act: T['act'] }).act = validatedAct;
  (guarded as unknown as { act: T['act'] }).act = validatedAct;
  ...
  (client as { extract: T['extract'] }).extract = validatedExtract;
  (guarded as unknown as { extract: T['extract'] }).extract = validatedExtract;
  ...
  (client as { observe: T['observe'] }).observe = validatedObserve;
  (guarded as unknown as { observe: T['observe'] }).observe = validatedObserve;
