/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-voice-webhooks` (ST-04-340).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/voice-webhooks
...
describe('tarball drift — @blackunicorn/bonklm-voice-webhooks', () => {
