/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-memory-utils` (ST-04-346).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/memory-utils
...
describe('tarball drift — @blackunicorn/bonklm-memory-utils', () => {
