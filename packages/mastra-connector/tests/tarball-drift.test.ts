/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-mastra` (ST-04-328).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/mastra-connector
...
describe('tarball drift — @blackunicorn/bonklm-mastra', () => {
