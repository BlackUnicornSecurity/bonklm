 ...
 * - Input validation
 * - Output validation
 * - Tool call validation (regression)
 * - Structured content handling (regression)
 * - Production mode errors (regression)
 * - Validation timeout (regression)
 * - Content length limits (regression)
 * - Streaming validation (regression, regression)
 */
...
describe('Mastra Guardrail Integration', () => {
  describe('messagesToText utility', () => {
    ...
    it('should extract text from array content (regression)', () => {
    ...
    it('should extract tool use content (regression)', () => {
      const messages: MastraMessage[] = [
        {
          role: 'assistant',
          content: [
  ...
  describe('toolCallsToText utility', () => {
    it('should extract tool call information (regression)', () => {
    ...
    it('should handle unparseable tool input (regression)', () => {
  ...
  describe('createGuardedMastra', () => {
    ...
    describe('beforeAgentExecution', () => {
      ...
      it('should block structured content with prompt injection (regression)', async () => {
        const messages: MastraMessage[] = [
          {
            role: 'user',
            content: [
      ...
      it('should respect maxContentLength limit (regression)', async () => {
    ...
    describe('validateToolCall', () => {
      ...
      it('should block malicious tool call inputs (regression)', async () => {
        const toolCall: MastraToolCall = {
          id: 'tool-1',
          name: 'execute',
          input: { command: 'rm -rf /' }
    ...
    describe('createStreamValidator', () => {
      ...
      it('should accumulate chunks for buffer mode (regression)', async () => {
      ...
      it('should enforce maxStreamBufferSize (regression)', async () => {
    ...
    describe('production mode', () => {
      it('should use generic errors in production mode (regression)', async () => {
    ...
    describe('validation timeout', () => {
      it('should timeout validation after configured time (regression)', async () => {
  ...
  describe('edge cases', () => {
    ...
    it('should handle circular references in tool input (regression)', () => {
