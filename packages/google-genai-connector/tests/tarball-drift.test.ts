/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-google-genai` (ST-04-303).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/google-genai-connector
...
describe('tarball drift — @blackunicorn/bonklm-google-genai', () => {
