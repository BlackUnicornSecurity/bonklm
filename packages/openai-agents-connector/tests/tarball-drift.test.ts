/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-openai-agents` (ST-04-330).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/openai-agents-connector
...
describe('tarball drift — @blackunicorn/bonklm-openai-agents', () => {
