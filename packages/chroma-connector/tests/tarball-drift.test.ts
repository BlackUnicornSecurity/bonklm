/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-chroma` (ST-04-313).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/chroma-connector
...
describe('tarball drift — @blackunicorn/bonklm-chroma', () => {
