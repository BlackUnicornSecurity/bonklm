/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-pinecone` (ST-04-314).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/pinecone-connector
...
describe('tarball drift — @blackunicorn/bonklm-pinecone', () => {
