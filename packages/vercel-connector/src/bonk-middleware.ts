/**
 * Vercel AI SDK v5/v6 Middleware Pattern
 * ==================================================
 *
...
/**
 * extract validatable text from v5/v6 message arrays.
