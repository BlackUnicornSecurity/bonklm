/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-temporal` (ST-04-323).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/temporal-middleware
...
describe('tarball drift — @blackunicorn/bonklm-temporal', () => {
