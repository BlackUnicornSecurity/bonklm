/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-anthropic` (ST-04-300).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/anthropic-connector
...
describe('tarball drift — @blackunicorn/bonklm-anthropic', () => {
