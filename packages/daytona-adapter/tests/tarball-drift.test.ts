/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-daytona` (ST-04-344).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/daytona-adapter
...
describe('tarball drift — @blackunicorn/bonklm-daytona', () => {
