/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-mistral` (ST-04-302).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/mistral-connector
...
describe('tarball drift — @blackunicorn/bonklm-mistral', () => {
