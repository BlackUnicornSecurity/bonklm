 ...
 * Proxy-based; intercepts the 5 sub-resources
 * (`chat`, `agents`, `fim`, `embeddings`, `classifiers`) and passes
...
interface ResolvedOptions {
  ...
  /**
   * opt-in to validate ALL messages
 ...
 * into the consumer's engine when `defaultLocale: 'auto'`.
...
async function fireModerateSecondOpinion(
  ...
  // NARROW the forwarded moderation
