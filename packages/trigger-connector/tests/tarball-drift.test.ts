/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-trigger` (ST-04-327).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/trigger-connector
...
describe('tarball drift — @blackunicorn/bonklm-trigger', () => {
