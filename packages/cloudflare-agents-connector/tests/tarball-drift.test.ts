/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-cloudflare-agents` (ST-04-325).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/cloudflare-agents-connector
...
describe('tarball drift — @blackunicorn/bonklm-cloudflare-agents', () => {
