/**
 * Story 3.8 — Cloudflare Agents connector types
 * ================================================
 *
 ...
 *
 * Sprint 22 audit closure (architect convergent + necessary
...
/**
 * Hook-context metadata for downstream validators. Sprint 22 AC:
...
export interface CloudflareAgentBlockEvent {
  /** Sprint 21 architect C1 closure: cross-package kind discriminator. */
