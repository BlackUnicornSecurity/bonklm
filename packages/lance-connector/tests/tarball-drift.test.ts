/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-lance` (ST-04-338).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/lance-connector
...
describe('tarball drift — @blackunicorn/bonklm-lance', () => {
