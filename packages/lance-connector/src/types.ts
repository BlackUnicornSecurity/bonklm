 ...
 *
 * The connector-style guide mandates `createGuardedLanceTable(table, opts)` —
...
export interface GuardedLanceTableOptions {
   ...
   * @default 'text'
   *
   * @security sec S1 closure (review): consumers MUST list
   ...
   *     unvalidated writes).
   *
   * @security sec S3 closure (review): a consumer writing
   ...
   *
   * @security sec S2 closure (review): the original silent
   ...
   * @default 1000
   *
   * @security sec S6 closure (review): a consumer who
   ...
   * @default 'block'
   *
   * @security rev R2 closure (review): silently shipping
