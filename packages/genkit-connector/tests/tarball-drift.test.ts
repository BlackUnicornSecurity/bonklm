/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-genkit` (ST-04-310).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/genkit-connector
...
describe('tarball drift — @blackunicorn/bonklm-genkit', () => {
