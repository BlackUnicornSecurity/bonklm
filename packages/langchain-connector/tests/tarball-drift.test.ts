/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-langchain` (ST-04-307).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/langchain-connector
...
describe('tarball drift — @blackunicorn/bonklm-langchain', () => {
