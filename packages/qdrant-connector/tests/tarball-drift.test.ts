/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-qdrant` (ST-04-315).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/qdrant-connector
...
describe('tarball drift — @blackunicorn/bonklm-qdrant', () => {
