/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-web-middleware-utils` (ST-04-347).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/web-middleware-utils
...
describe('tarball drift — @blackunicorn/bonklm-web-middleware-utils', () => {
