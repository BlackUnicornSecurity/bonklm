/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-server` (ST-04-350).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/bonklm-server
...
describe('tarball drift — @blackunicorn/bonklm-server', () => {
