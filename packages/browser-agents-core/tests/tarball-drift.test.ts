/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-browser-agents-core` (ST-04-343).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/browser-agents-core
...
describe('tarball drift — @blackunicorn/bonklm-browser-agents-core', () => {
