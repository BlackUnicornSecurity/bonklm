/**
 * Story 3.10 — `wrapVoltAgent(agent, opts)`
 * ===========================================
 *
 ...
 *
 * Sprint 22 audit-pattern compliance: Symbol-watermark double-wrap
 ...
 *
 * Sprint 23 audit closure (anticipated architect C-1 follow-up):
