/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-voltagent` (ST-04-329).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/voltagent-connector
...
describe('tarball drift — @blackunicorn/bonklm-voltagent', () => {
