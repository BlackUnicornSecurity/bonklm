...
describe('Ollama Guarded Wrapper', () => {
  ...
  describe('Stream Validation Behavior', () => {
    ...
    describe('buffer mode (hold-back-and-release)', () => {
      ...
      it('propagates StreamValidationError when the chat buffer exceeds the limit (regression)', async () => {
      ...
      it('caps the retained-response count on a zero-text response flood (regression)', async () => {
