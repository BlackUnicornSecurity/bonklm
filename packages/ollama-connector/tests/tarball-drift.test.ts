/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-ollama` (ST-04-304).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/ollama-connector
...
describe('tarball drift — @blackunicorn/bonklm-ollama', () => {
