/**
 * `BonklmAgent`: LiveKit `Agent` subclass with bonklm
 ...
 * will explore an incremental-validate
...
export class BonklmAgent<UserData = unknown> extends Agent<UserData> {
  ...
  override async ttsNode(
    ...
    return super.ttsNode(stringToStream(accumulated), modelSettings);
  }
