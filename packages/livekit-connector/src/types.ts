/**
 * Story 3.3 — LiveKit Agents Connector types
 * ===========================================
 *
 * Sprint 18 3-lane audit closure (architect C-4 + code-reviewer BLOCK-1):
 ...
 * get IDE completion (Sprint 18 audit architect C-5 closure).
 */
...
export interface LiveKitGuardrailConfig {
  ...
  /**
   * Partial-path latency ceiling. Story 3.1 AC-a: <100ms on M2-class
   * CPU. Default: 100.
   */
