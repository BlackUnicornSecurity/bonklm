/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-livekit` (ST-04-333).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/livekit-connector
...
describe('tarball drift — @blackunicorn/bonklm-livekit', () => {
