/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-nestjs` (ST-04-319).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/nestjs-module
...
describe('tarball drift — @blackunicorn/bonklm-nestjs', () => {
