/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-mcp` (ST-04-312).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/mcp-connector
...
describe('tarball drift — @blackunicorn/bonklm-mcp', () => {
