/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-elysia` (ST-04-321).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/elysia-plugin
...
describe('tarball drift — @blackunicorn/bonklm-elysia', () => {
