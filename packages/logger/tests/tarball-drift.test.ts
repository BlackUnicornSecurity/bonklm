/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-logger` (ST-04-348).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/logger
...
describe('tarball drift — @blackunicorn/bonklm-logger', () => {
