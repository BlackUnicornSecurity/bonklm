/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-eko` (ST-04-331).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/eko-connector
...
describe('tarball drift — @blackunicorn/bonklm-eko', () => {
