/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm` (ST-04-351).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/core
...
describe('tarball drift — @blackunicorn/bonklm', () => {
