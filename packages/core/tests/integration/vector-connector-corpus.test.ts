...
import { PIIGuard, PromptInjectionValidator, SecretGuard, createRetrievedDocValidator } from '../../src/index.js';
...
describe('Sprint 14 deferred-closure item E — cross-connector vector UAT corpus', () => {
  ...
  const validators = [new PromptInjectionValidator(), new SecretGuard(), new PIIGuard()];
