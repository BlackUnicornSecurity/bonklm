 ...
 * thrown `ConnectorValidationError` message (security regression). A custom validator returns
...
describe('applyRetrievedDocValidatorToMatches — CWE-117 throw sanitization (security regression)', () => {
