 ...
 * regression timeout primitive shared by all 22 connectors.
 *
...
describe('validateWithTimeoutSecure', () => {
  ...
  describe('memoization', () => {
    ...
    it('memoizes even when factory legitimately returns the same shape twice (Sprint 31 hardening)', async () => {
