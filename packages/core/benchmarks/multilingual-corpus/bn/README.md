...
**Status**: Sprint 17 seed corpus (Story 3.12 Pass 2). Patterns landed Sprint 17. Native-speaker review pending — `curator: "claude-opus-4.7-seed"` on all entries.

**Script**: Bengali (বাংলা). Left-to-right.
**Speakers**: 270M+ native + L2.
**Patterns added**: 4 (system_override / constraint_removal / mode_switching / role_hijacking).
**Sprint 21 hand-off**: native reviewer signs off; curator field updated; jailbreak + reformulation_trigger backfill per GAP-1/2.
