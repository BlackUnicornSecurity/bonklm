...
3. Pattern catalogues evolve. The numbers above reflect the v1.0.0 patterns. Future minor versions
   may add patterns and shift the numbers; re-run before re-quoting.
