/**
 * Story 1.3b — Shadow Log Primitive (Types)
 * ==========================================
 *
 ...
 * them. ElizaOS Story 2.4a uses it to close the Class-4 vulnerability
 ...
 *  - Story 2.5 Mem0 — additive integrity check on archival memory.
 *  - Story 2.5 Zep — same.
 *  - Story 3.8 Cloudflare DO setState — tamper-evident agent state.
 *
 ...
 * `SourceTrust` taxonomy used by the ElizaOS connector (Story 1.8).
 */
 ...
 *    ships in Story 2.4a.
 *  - Cloudflare DO `setState` — Story 3.8.
 *
 ...
 * to read `roomId`. The connector layer (Story 2.4a's ElizaOS
