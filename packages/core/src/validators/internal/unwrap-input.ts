/**
 * Sprint 16 cumulative hardening (code-reviewer CONCERN-2 + security
 ...
 * (the upstream realtime SDK already did the audio→text
 * transcription).
 */
 ...
 * may evade ASCII regex scans. A planned Unicode-escape
