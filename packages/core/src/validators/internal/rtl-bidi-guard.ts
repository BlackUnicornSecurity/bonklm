/**
 * Pass 2 — RTL bidi-control attack guard
 * ==============================================================
 *
...
/**
 * Regex matching bidi-control code points. Sprint 17 hardening
 ...
 * the `.test` fast-path to avoid the lastIndex footgun).
 *
 ...
 * here because the langs (Arabic, Urdu, Bengali) have no
 * uppercase. Turkish-aware lowercasing lands when `tr` ships.
 */
