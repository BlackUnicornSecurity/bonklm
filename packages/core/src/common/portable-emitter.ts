 ...
 * =============================
 * edge-core: replaces `node:events` imports with a tiny
 * portable emitter. Eliminates the ESM-import hazard where `node:events`
 * is not always-resolvable under bundlers targeting non-Node runtimes.
 *
