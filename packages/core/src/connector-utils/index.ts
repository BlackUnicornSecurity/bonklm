...
// release-gate primitive (also reused by audio).
export { BufferedReleaseGate, type BufferedReleaseGateConfig } from './buffered-release-gate.js';

// Validate-before-release gate for structured-chunk
...
// Sprint 20 hardening — shared validator-adapter for connectors
...
// Sprint 22 hardening (architect C2 + code-reviewer C-4) — shared
...
// sanitizeReasonText canonical home.
...
// canonical timeout primitive. Replaces the broken
