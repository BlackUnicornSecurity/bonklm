/**
 * Sprint 22 cumulative hardening (architect C2 + code-reviewer
 ...
 *
 * @public v1.0-RC1 API freeze. Connector authors building
 ...
 * on its prototype).
 *
 * @public v1.0-RC1 API freeze. Non-enumerable,
