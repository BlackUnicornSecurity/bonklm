...
/**
 * default `minBufferBeforeRelease` when neither
...
export interface StreamValidationOptions {
  ...
  /**
   * `processForClient` release-gate threshold.
   *
  ...
  /**
   * build-time hint from the middleware
  ...
  /**
   * sentence-boundary heuristic for the release gate.
   * @default true
   */
  detectSentenceBoundary?: boolean;
  /**
   * minimum buffer length before a sentence terminator
...
/**
 * return shape for `processForClient` / `finalizeForClient`.
 ...
 * the `processForClient()` / `finalizeForClient()` lifecycle
...
export class StreamValidator {
  ...
  // ───────────────────────────────────────────────────────────────────────
  // validate-before-release client gate
  // ───────────────────────────────────────────────────────────────────────
  ...
  /**
   * final-flush release-gate API. Validate any content
