 ...
 * ===================================================
 * Phase-1 ships the portable subset of BonkLM's core API
 ...
 * has no `vm`; an edge variant of HookSandbox lands in
 *   a later phase.
...
// Provenance-gated indirect-injection. Edge-safe: pure regex
...
// portable codec helpers (also useful for connector
...
// edge-core: function-only HookManager variant + ALS canary
...
// shadow log primitive (edge-portable, uses Web Crypto).
export {
  createShadowLog,
