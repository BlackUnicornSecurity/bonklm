...
/**
 * canonical surface vocabulary lock.
 *
 ...
 * with sprint-team approval. OTel emits `bonklm.surface` using
 * these exact strings.
 */
...
export type ValidatorInput =
  ...
  | {
      /**
       * audio-stream `validate(input)` entry point. Carries
 ...
 *
 * @public v1.0-RC1 API freeze. Adding a required method
