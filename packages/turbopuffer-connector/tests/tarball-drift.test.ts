/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-turbopuffer` (ST-04-337).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/turbopuffer-connector
...
describe('tarball drift — @blackunicorn/bonklm-turbopuffer', () => {
