/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-voltops-otel` (ST-04-349).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/voltops-otel-adapter
...
describe('tarball drift — @blackunicorn/bonklm-voltops-otel', () => {
