/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-nextjs` (ST-04-324).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/nextjs-helpers
...
describe('tarball drift — @blackunicorn/bonklm-nextjs', () => {
