/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-weaviate` (ST-04-316).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/weaviate-connector
...
describe('tarball drift — @blackunicorn/bonklm-weaviate', () => {
