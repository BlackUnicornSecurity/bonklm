/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-llamaindex` (ST-04-308).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/llamaindex-connector
...
describe('tarball drift — @blackunicorn/bonklm-llamaindex', () => {
