/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-restate` (ST-04-322).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/restate-middleware
...
describe('tarball drift — @blackunicorn/bonklm-restate', () => {
