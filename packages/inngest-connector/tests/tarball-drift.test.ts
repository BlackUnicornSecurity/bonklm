/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-inngest` (ST-04-326).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/inngest-connector
...
describe('tarball drift — @blackunicorn/bonklm-inngest', () => {
