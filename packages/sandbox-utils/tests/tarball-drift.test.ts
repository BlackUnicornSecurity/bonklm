/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-sandbox-utils` (ST-04-342).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/sandbox-utils
...
describe('tarball drift — @blackunicorn/bonklm-sandbox-utils', () => {
