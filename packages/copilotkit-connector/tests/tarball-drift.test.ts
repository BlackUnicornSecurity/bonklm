/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-copilotkit` (ST-04-311).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/copilotkit-connector
...
describe('tarball drift — @blackunicorn/bonklm-copilotkit', () => {
