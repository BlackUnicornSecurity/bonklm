/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-inference-providers` (ST-04-339).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/inference-providers
...
describe('tarball drift — @blackunicorn/bonklm-inference-providers', () => {
