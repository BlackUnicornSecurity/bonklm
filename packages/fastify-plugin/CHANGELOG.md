...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.16
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.15
...
- Updated dependencies [a8c6181]
  ...
  - @blackunicorn/bonklm-logger@1.0.14
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.13
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.12
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.11
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.10
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.9
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.8
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.7
...
- Updated dependencies
  ...
  - @blackunicorn/bonklm-logger@1.0.6
...
- Updated dependencies [c0b2255]
  ...
  - @blackunicorn/bonklm-logger@1.0.5
...
- Updated dependencies [eee1352]
  ...
  - @blackunicorn/bonklm-logger@1.0.4
...
- Updated dependencies [90e4947]
  ...
  - @blackunicorn/bonklm-logger@1.0.2

## 1.0.1

### Patch Changes

- Harden the server dependency closure, preserve concrete Fastify 5 path filters while preferring
  `routeOptions.url` with a query-free route fallback, and ensure clean workspace builds compile
...
- Require the patched Fastify 5 line (`^5.8.5`) rather than advertising an unpatched legacy major.
- Validate byte request bodies, reject encoded responses unless a trusted extractor can inspect
  them, and keep custom error handling fail-closed. Blocked response replacements now use a clean
  JSON representation and status.
- Updated dependencies
  - @blackunicorn/bonklm@1.0.1
  - @blackunicorn/bonklm-logger@1.0.1
