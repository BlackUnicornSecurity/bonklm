/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-fastify` (ST-04-318).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/fastify-plugin
...
describe('tarball drift — @blackunicorn/bonklm-fastify', () => {
