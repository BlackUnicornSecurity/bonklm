/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-letta` (ST-04-334).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/letta-connector
...
describe('tarball drift — @blackunicorn/bonklm-letta', () => {
