/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-express` (ST-04-317).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/express-middleware
...
describe('tarball drift — @blackunicorn/bonklm-express', () => {
