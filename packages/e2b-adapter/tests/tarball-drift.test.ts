/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-e2b` (ST-04-345).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/e2b-adapter
...
describe('tarball drift — @blackunicorn/bonklm-e2b', () => {
