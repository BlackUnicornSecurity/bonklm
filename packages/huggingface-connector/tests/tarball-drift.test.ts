/**
 * Tarball-drift snapshot test — `@blackunicorn/bonklm-huggingface` (ST-04-305).
 *
 ...
 *   pnpm build && node scripts/regen-tarball-snapshot.mjs packages/huggingface-connector
...
describe('tarball drift — @blackunicorn/bonklm-huggingface', () => {
