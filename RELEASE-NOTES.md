...
> **Latest in-tree family version:** `1.0.13`

> **Registry reality (npm-verified 2026-07-12):** despite the in-tree **v1.0.0** cut/tag dated
> 2026-07-11, the only package ever _published_ to npm is **`@blackunicorn/bonklm` (core) `0.2.0`,
> 2026-02-23** — npm `dist-tags.latest = 0.2.0`, and it is the sole published version. No connector,
> logger, or wizard package has reached npm. The release workflow now targets npmjs.org and GHCR
> from one published GitHub Release. `1.0.1` was versioned in-tree but never published; **`v1.0.13`
> is the first release published through the release-triggered lane.** Full detail is in
> [CHANGELOG.md](./CHANGELOG.md#102--2026-08-15); historical notes v0.3.0→v1.0.0 remain there too.
