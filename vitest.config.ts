  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'tools/release-npm-normalize.js',
      ...
      thresholds: {
        ...
        // Deterministic-pack normalizer guards the release lane's idempotency
        // (rerun byte-stability); a silently dropped fail-closed branch there
        // reopens the nondeterministic-tarball defect.
        'tools/release-npm-normalize.js': {
          lines: 100,
          functions: 100,
          branches: 100,
